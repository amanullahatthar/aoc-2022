...
2. In the second round, your opponent will choose Paper (B), and you should choose Rock (X). This ends in a loss for you with a score of 1 (1 + 0).
...
2. In the second round, your opponent will choose Paper (B), and you choose Rock so you lose (X) with a score of 1 + 0 = 1.
3. In the third round, you will defeat your opponent's Scissors with Rock for a score of 1 + 6 = 7.
